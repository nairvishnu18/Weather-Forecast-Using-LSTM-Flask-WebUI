...
excel_files = pd.read_excel('WindSpeedPune.xlsx')

# Convert it to CSV Format 
data_csv = excel_files.to_csv('WindSpeedPune.csv',index=None,header=True)


data = pd.read_csv('WindSpeedPune.csv')
...
pickle.dump(model,open('pune-windspeed-model.pkl','wb'))
