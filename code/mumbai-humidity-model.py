...
excel_files = pd.read_excel('mumbaihumidity.xlsx')

# Convert it to CSV Format 
data_csv = excel_files.to_csv('mumbaihumidity.csv',index=None,header=True)


data = pd.read_csv('mumbaihumidity.csv')
...
pickle.dump(model,open('mumbai-humid-model.pkl','wb'))
