...
model = pickle.load(open('mumbai-windspeed-model.pkl','rb'))

data = pd.read_csv('./dataset/WindspeedBombay.csv')
...
with open('mumbai-windspeed-predicted.csv','a',newline='')as f:
