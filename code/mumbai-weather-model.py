...
excel_files = pd.read_excel('Prediction-Dataset-Weather-2009-2020.xlsx')

# Convert it to CSV Format 
data_csv = excel_files.to_csv('Prediction-Dataset-Weather-2009-2020.csv',index=None,header=True)
