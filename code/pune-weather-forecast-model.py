...
excel_files = pd.read_excel('pune.xlsx')

# Convert it to CSV Format 
data_csv = excel_files.to_csv('pune-dataset.csv',index=None,header=True)


data = pd.read_csv('pune-dataset.csv')


temp = data['TempC'].values
...
pickle.dump(model,open('model-pune.pkl','wb'))
