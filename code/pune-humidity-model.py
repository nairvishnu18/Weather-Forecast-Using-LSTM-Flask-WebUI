...
excel_files = pd.read_excel('punehumidity.xlsx')

# Convert it to CSV Format 
data_csv = excel_files.to_csv('punehumidity.csv',index=None,header=True)


data = pd.read_csv('punehumidity.csv')
...
pickle.dump(model,open('pune-humid-model.pkl','wb'))
